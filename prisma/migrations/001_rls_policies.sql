...
-- Note: This requires PostGIS to be installed on the database
-- CREATE EXTENSION IF NOT EXISTS postgis;

-- Create spatial index for CoffeeShop location queries
-- This makes "cafés near me" queries lightning fast
